...
def process(self):
    ...
    imgs = {
        'img':[dict(license=self.cc_by_license, data_source=return_ds[0], publisher=''), dict(url='https://kalenteri.turku.fi/sites/default/files/styles/event_node/public/images/event_ext/sadonkorjuutori.jpg', name='',photographer_name='',alt_text='')]
    }
