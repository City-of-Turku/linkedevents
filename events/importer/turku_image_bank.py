...
def process(self):
    ...
    imgs = {
        'img':[dict(license=self.cc_by_license, dict(data_source=return_ds[0], publisher=return_org[0]), dict(url='https://kalenteri.turku.fi/sites/default/files/styles/event_node/public/images/event_ext/sadonkorjuutori.jpg')]
    }
