...
def get_create_organizationclass(ob, args):
    try:
        ...
        logger.warn("OrganizationClass update_or_create did NOT pass: " +
                    ob+" correctly. Argument/Arguments incompatible.")
...
def process(self):
    ...
    imgs = {
        ...
        'img_4': [dict(license=self.cc_by_license, data_source=return_ds[0], publisher=return_org[0]), dict(url='https://kalenteri.turku.fi/sites/default/files/styles/event_node/public/images/event_ext/nuorten_viikonloppu_turun_seudun_tapahtumakalenterin_kuva_yhdistetty.jpg', name='', photographer_name='', alt_text='')]
    }
